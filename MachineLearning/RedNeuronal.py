...
red = MLPClassifier(max_iter=90000, hidden_layer_sizes=(10,20))
red.fit(X_train,y_train)                                # Variables de entrenamiento

porcentaje = 100*red.score(X_test, y_test)
print("[+]Aprendizaje de: {:.2f}%".format(porcentaje))  # Porcentaje de predicciones que tuvo
